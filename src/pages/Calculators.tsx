      ...
      <main className="flex-grow pt-24 pb-16 sm:pt-28 md:pt-32 sm:pb-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-0 animate-fade-in [animation-delay:300ms]">
            ...
            <p className="mb-2 sm:mb-2 text-muted-foreground pl-4 border-l-2 border-blue-400/20 text-sm sm:text-base">
              Guidelines to help meet your daily hydration needs.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-1 mb-1 sm:mb-2">
              <CalculatorCard 
          ...
          <section className="mb-0 animate-fade-in [animation-delay:400ms]">
            ...
            <p className="mb-2 sm:mb-2 text-muted-foreground pl-4 border-l-2 border-green-400/20 text-sm sm:text-base">
          ...
          <section className="mb-0 animate-fade-in [animation-delay:500ms]">
            ...
            <p className="mb-2 sm:mb-2 text-muted-foreground pl-4 border-l-2 border-purple-400/20 text-sm sm:text-base">
          ...
          <section className="mb-0 animate-fade-in [animation-delay:400ms]">
            ...
            <p className="mb-4 text-muted-foreground pl-4 border-l-2 border-gray-500/20 text-base sm:text-lg">
